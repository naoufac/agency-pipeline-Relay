...
function roadmap(){
  const P = [
    ...
    { n:'PQ3', t:'A CMS a client can actually use', s:'next', d:'Per-site content collections in Directus (Products, Menu, Posts, Team…) that a non-technical client can edit and see change live — not one opaque "pages" JSON row. Gate: create/edit a product in the CMS admin and it appears on the live site.' },
