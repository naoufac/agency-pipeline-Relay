...
export type BuilderId = 'directus' | 'wordpress' | 'app' | 'campaign' | 'prestashop' | 'astro';
export const BUILDER_IDS: BuilderId[] = ['directus', 'wordpress', 'app', 'campaign', 'prestashop', 'astro'];
